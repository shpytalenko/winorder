...
class PullGoogleSheet
  ...
  def get_sheet(client, drive, title)
   access_token = client.authorization.access_token
   session = GoogleDrive.login_with_oauth(access_token)
   q_form = session.spreadsheet_by_title(title).worksheet_by_title("Quote Form")
   spec   = session.spreadsheet_by_title(title).worksheet_by_title("Unit Specifications")
